...
public class CallRecordLogCreator {
	...
	private String generateRecord() {
		...
		String length = String.format("%02d:%02d", rnd.nextInt(7),
				rnd.nextInt(60));
		return String
				.format("{\"datetime\":\"%s\",\"from\":\"%s\",\"to\":\"%s\",\"length\":\"%s\"}",
	...
	/*
	 * public static void main(String args[]) { CallRecordLogCreator c = new
	 * CallRecordLogCreator(); for (int i=0; i<100; i++)
	 * System.out.println(c.generateRecord()); c.writeToFile("C:/log2.txt"); }
	 */
}